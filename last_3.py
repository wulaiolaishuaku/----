...
class DWA:
    ...
    def detect_obstacles(self, ranges):
        ...
        target_angle_315 = 315
        target_angle_320 = 320
        target_angle_325 = 325
        target_angle_330 = 330
        target_angle_335 = 335
        target_angle_340 = 340
        target_angle_345 = 345
        target_angle_350 = 350
        index_10 = int(target_angle_10 / angle_resolution)  
        index_15 = int(target_angle_15 / angle_resolution)
        index_20 = int(target_angle_20 / angle_resolution) 
        index_25 = int(target_angle_25 / angle_resolution)  
        index_30 = int(target_angle_30 / angle_resolution) 
        index_35 = int(target_angle_35 / angle_resolution)
        index_40 = int(target_angle_40 / angle_resolution)
        index_45 = int(target_angle_45 / angle_resolution)  
        index_50 = int(target_angle_50 / angle_resolution)  
        index_55 = int(target_angle_55 / angle_resolution)
        index_60 = int(target_angle_60 / angle_resolution) 
        index_65 = int(target_angle_65 / angle_resolution)
        index_70 = int(target_angle_70 / angle_resolution)  
        index_75 = int(target_angle_75 / angle_resolution)
        index_80 = int(target_angle_80 / angle_resolution)  
        index_85 = int(target_angle_85 / angle_resolution)
        ...
        index_285 = int(target_angle_285 / angle_resolution)
        index_290 = int(target_angle_290 / angle_resolution)
        index_295 = int(target_angle_295 / angle_resolution)
        index_300 = int(target_angle_300 / angle_resolution)
        index_305 = int(target_angle_305 / angle_resolution)
        index_310 = int(target_angle_310 / angle_resolution)
        index_315 = int(target_angle_315 / angle_resolution)
        index_320 = int(target_angle_320 / angle_resolution)
        index_325 = int(target_angle_325 / angle_resolution)
        index_330 = int(target_angle_330 / angle_resolution)
        index_335 = int(target_angle_335 / angle_resolution)
        index_340 = int(target_angle_340 / angle_resolution)
        index_345 = int(target_angle_345 / angle_resolution)
        ...
        if index_90 < len(ranges) and index_270 < len(ranges) and index_30 < len(ranges) and index_330 < len(ranges) and index_60 < len(ranges) and index_300 < len(ranges):
            ...
            self.value_at_15 = ranges[index_15]
            self.value_at_20 = ranges[index_20]
            self.value_at_25 = ranges[index_25]
            self.value_at_30 = ranges[index_30]
            self.value_at_35 = ranges[index_35]
            self.value_at_40 = ranges[index_40]
            self.value_at_45 = ranges[index_45]
            self.value_at_50 = ranges[index_50]
            self.value_at_55 = ranges[index_55]
            self.value_at_60 = ranges[index_60]
            self.value_at_65 = ranges[index_65]
            self.value_at_70 = ranges[index_70]
            self.value_at_75 = ranges[index_75]
            self.value_at_80 = ranges[index_80]
            self.value_at_85 = ranges[index_85]
            ...
            self.value_at_285 = ranges[index_285]
            self.value_at_290 = ranges[index_290]
            self.value_at_295 = ranges[index_295]
            self.value_at_300 = ranges[index_300]
            self.value_at_305 = ranges[index_305]
            self.value_at_310 = ranges[index_310]
            self.value_at_315 = ranges[index_315]
            self.value_at_320 = ranges[index_320]
            self.value_at_325 = ranges[index_325]
            self.value_at_330 = ranges[index_330]
            self.value_at_335 = ranges[index_335]
            self.value_at_340 = ranges[index_340]
            self.value_at_345 = ranges[index_345]
        ...
        while not rospy.is_shutdown():
            ...
            if current_distance_to_target < 1.0 :  # 如果距离小于0.5
                ...
                if best_trajectory is not None: 
                    ...
                    if self.first_value > 1.2 :  
                        if abs(self.angle) < 2 :   
                            if self.change_count % 2 == 0 :   
                                if self.value_at_90 < 0.4 or self.value_at_30 < 0.6 or self.value_at_60 < 0.6 or self.value_at_10 < 0.6 or self.value_at_20 < 0.6 or self.value_at_40 < 0.5 or self.value_at_50 < 0.5 or self.value_at_70 < 0.5 or self.value_at_80 < 0.5 or self.value_at_15 < 0.6 or self.value_at_25 < 0.6 or self.value_at_35 < 0.6 or self.value_at_45 < 0.6 or self.value_at_55 < 0.5 or self.value_at_65 < 0.5 or self.value_at_75 < 0.5 or self.value_at_85 < 0.5:
                                    v = 0.1  
                                    omega = -0.3   
                                elif self.value_at_300 < 0.6 or self.value_at_270 < 0.4 or self.value_at_330 < 0.6 or self.value_at_320 < 0.6 or self.value_at_310 < 0.6 or self.value_at_290 < 0.5 or self.value_at_280 < 0.5 or self.value_at_340 < 0.6 or self.value_at_350 < 0.6 or self.value_at_275 < 0.5 or self.value_at_285 < 0.55 or self.value_at_295 < 0.55 or self.value_at_305 < 0.55 or self.value_at_315 < 0.55 or self.value_at_325 < 0.55 or self.value_at_335 < 0.6 or self.value_at_345 < 0.6 :
                                    v = 0.1  
                                    omega = 0.3    
                                else : 
                        ...
                        if self.change_count % 2 == 0 :   
                            ...
                            if abs(self.angle) > 2 :  
                                ...
                                if self.angle > 0 :
                                    if self.value_at_90 < 0.6 and self.value_at_90 < self.value_at_270 :
                                        omega = -0.7   
                                        v = 0   
                                    else:
                                        omega = 0.7   
                                    ...
                                    if self.value_at_270 < 0.6 and self.value_at_270 < self.value_at_90:
                                        omega = 0.7
                                        v = 0 
                                    else:
                                        omega = -0.7
